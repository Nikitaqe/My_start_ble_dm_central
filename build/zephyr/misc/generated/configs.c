...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HOGP_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HOGP_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HOGP_REPORTS_MAX, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DDFS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DDFS_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PPI_TRACE_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DM_MODULE_LOG_LEVEL_DEFAULT, 1);
